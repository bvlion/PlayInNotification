...
class DifficultKanjiQuestionDataTest {
  ...
  @Test
  fun `Lv1とLv2に300語、Lv3に200語、Lv4とLv5に100語ずつ収録されている`() {
    ...
    assertEquals(200, entriesByDifficulty.getValue(3).size)
    assertEquals(100, entriesByDifficulty.getValue(4).size)
    assertEquals(100, entriesByDifficulty.getValue(5).size)
    assertEquals(1000, entriesByDifficulty.values.flatten().size)
  }
